        ...
        $settings_fields = [
            ...
            'element_pack_elementor_extend' => [
                ...
                [
                    ...
                    'label'   => esc_html__( 'Widget Transform', 'bdthemes-element-pack' ),
                     'desc'              => __( 'Learn <a href="https://youtu.be/Djc6bP7CF18" target="_blank">how to use</a> widget transform for your any widget.', 'bdthemes-element-pack' ),
                    'type'    => 'checkbox',
                    'default' => "off",
                ],
            ...
            'element_pack_api_settings' => [
                ...
                [
                    ...
                    'label'             => esc_html__( 'Weather Access', 'bdthemes-element-pack' ),
                ...
                [
                    'name'              => 'map_subheading',
                    'label'             => esc_html__( 'Map Access', 'bdthemes-element-pack' ),
