	...
	public function translate_fields( $widgets ) {
		...
		$widgets['pp-fluent-forms']         = [
			...
			'fields'     => [
				[
					'field'       => 'form_title_custom',
					'type'        => __( 'Fluent Forms - Title', 'power-pack' ),
					'editor_type' => 'LINE',
				],
				[
					'field'       => 'form_description_custom',
					'type'        => __( 'Fluent Forms - Description', 'power-pack' ),
					'editor_type' => 'AREA',
				],
			],
		];
		$widgets['pp-formidable-forms']     = [
			...
			'fields'     => [
				[
					'field'       => 'form_title_custom',
					'type'        => __( 'Formidable Forms - Title', 'power-pack' ),
					'editor_type' => 'LINE',
				],
				[
					'field'       => 'form_description_custom',
					'type'        => __( 'Formidable Forms - Description', 'power-pack' ),
					'editor_type' => 'AREA',
				],
			],
		];
		...
		$widgets['pp-image-slider']         = [
			'conditions' => [ $this->type => 'pp-image-slider' ],
			'fields'     => [
				[
					'field'       => 'filter_label',
					'type'        => __( 'Image Slider - Filter Label', 'power-pack' ),
					'editor_type' => 'LINE',
				],
				[
					'field'       => 'filter_all_label',
					'type'        => __( 'Image Slider - "All" Filter Label', 'power-pack' ),
					'editor_type' => 'LINE',
				],
				[
					'field'       => 'load_more_text',
					'type'        => __( 'Image Slider - Load More Button Text', 'power-pack' ),
					'editor_type' => 'LINE',
				],
			],
		];
