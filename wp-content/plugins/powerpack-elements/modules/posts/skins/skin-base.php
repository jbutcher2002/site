...
abstract class Skin_Base extends Elementor_Skin_Base {
		...
		<div class="pp-post-filters-container">
			<div class="pp-post-filters-wrap">
				<ul class="pp-post-filters">
					<li class="pp-post-filter pp-filter-current" data-filter="*" data-taxonomy=""><?php echo ( 'All' == $all_label || '' == $all_label ) ? __( 'All', 'powerpack' ) : $all_label; ?></li>
					<?php foreach ( $filters as $key => $value ) { ?>
					<li class="pp-post-filter" data-filter="<?php echo '.' . $value->slug; ?>" data-taxonomy="<?php echo '.' . $value->taxonomy; ?>"><?php echo $value->name; ?></li>
					<?php } ?>
				</ul>
			</div>
		</div>
	 ...
	 * @access protected
	 */
    public function render_ajax_post_body( $filter = '', $taxonomy = '' ) {
		ob_start();
